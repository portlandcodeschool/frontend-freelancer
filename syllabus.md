...
1. Working with job agencies like 52ltd and Vitamin T
...
1. Month 2 - Advanced HTML/CSS,  creating interactivity with jQuery; responsive design, web frameworks (Bootstrap),
1. Month 3 - Wordpress, specifying web applications with user stories and wireframes,  career guidance: portfolios, collaboration
